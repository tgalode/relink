...
fn traduit_des_index_connus() {
    // Valeurs à confirmer sur `docs/protocol/gen1-species-index.md`.
    assert_eq!(national_dex_number(0x15), Some(1)); // Bulbizarre
    assert_eq!(national_dex_number(0x14), Some(151)); // Mew
}
...
fn un_pokemon_de_gen1_avec_des_capacites_de_gen1_passe() {
    // 0x15 est Bulbizarre selon `docs/protocol/gen1-species-index.md`.
